...
export function ChatHistory({ messages }: ChatHistoryProps) {
  ...
  return (
    <div
      ref={scrollRef}
      className="min-h-[300px] sm:min-h-[400px] max-h-[400px] sm:max-h-[500px] overflow-y-auto bg-gradient-to-b from-gray-50 to-blue-50/30 rounded-xl p-3 sm:p-4 mb-4 shadow-inner border border-gray-100 scrollbar-thin flex-1"
    >
      {messages.length === 0 ? (
